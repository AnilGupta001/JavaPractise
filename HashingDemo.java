...
public class HashingDemo {
	public static Map<Character, List<String>> addName(String names[]) {
        ...
        for (String name : names) {
            ...
            List<String> list = map.getOrDefault(firstLetter, new ArrayList<>());
            list.add(name);
	 ...
	 public static void display(Map<Character, List<String>> map) {
	        for (char letter = 'A'; letter <= 'Z'; letter++) {
	            List<String> list = map.getOrDefault(letter, new ArrayList<>());
	            if (!list.isEmpty()) {
	                System.out.println(letter + ": " + String.join(", ", list));
	            }
	        }
	    }
